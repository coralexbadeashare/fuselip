...
from mmeb.mmeb_utils import MMEB_EVAL_SUBSETS
from vlm2vec_new.src.arguments import ModelArguments, DataArguments, TrainingArguments
from transformers import HfArgumentParser, AutoProcessor, AutoConfig

from vlm2vec_new.src.model import MMEBModel
from vlm2vec_new.src.dataset import EvalDataset
...
from vlm2vec_new.evaluation.eval_utils import get_pred
from vlm2vec_new.src.utils import print_rank
from vlm2vec_new.src.model_utils import get_backbone_name
...
def main():
    ...
    if data_args.subset_name is None:
        data_args.subset_name = MMEB_EVAL_SUBSETS
